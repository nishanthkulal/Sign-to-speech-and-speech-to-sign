...
['About App','Sign Language to Text (Action)','Sign Language to Text (Numbers)','Sign Language to Text(Alphabets)','Speech to sign Language']
)
...
if app_mode =='About App':
 ...
 #########################################################################################################################
elif app_mode == 'Sign Language to Text (Numbers)':
...
#########################################################################################################################
elif app_mode == 'Sign Language to Text(Alphabets)':
    st.title('Sign Language to Text(Alphabets)')
    st.set_option('deprecation.showfileUploaderEncoding', False)
